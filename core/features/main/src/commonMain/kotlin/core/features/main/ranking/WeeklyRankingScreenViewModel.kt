...
data class WeeklyRankingScreenState(
...
class WeeklyRankingScreenViewModel(
  private val playRepository: PlayRepository
) : ViewModel(), StateManager<WeeklyRankingScreenState> by ViewModelStateManager(
  WeeklyRankingScreenState()
